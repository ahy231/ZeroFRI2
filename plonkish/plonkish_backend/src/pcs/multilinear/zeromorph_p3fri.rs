use crate::pcs::univariate::{p3_open_helper, p3_verify_helper, P3FriCommitment};
...
use crate::{
    pcs::{
        ...
        univariate::{P3Fri, P3FriProverParams, P3FriVerifierParams},
...
#[derive(Clone, Debug)]
pub struct ZeromorphP3Fri<Pcs>(PhantomData<Pcs>);

#[derive(Clone, Debug, Serialize, Deserialize)]
pub struct ZeromorphP3FriProverParam<F: PrimeField> {
    commit_pp: P3FriProverParams<F>,
}

#[derive(Clone, Debug, Serialize, Deserialize)]
pub struct ZeromorphP3FriVerifierParam<F: PrimeField> {
    ...
    H: Hash,
{
    ...
    fn trim(
        ...
        Ok((
            ...
            ZeromorphP3FriVerifierParam { vp },
        ))
    }
    ...
    fn commit(pp: &Self::ProverParam, poly: &Self::Polynomial) -> Result<Self::Commitment, Error> {
        ...
        P3Fri::commit(&pp.commit_pp, &poly)
    }
...
mod test {
    use crate::{
        pcs::{
            multilinear::{
                ...
                zeromorph::Zeromorph,
                zeromorph_p3fri::ZeromorphP3Fri,
            },
            univariate::{P3Fri, UnivariateKzg},
        },
        util::{
    ...
    type Pcs = ZeromorphP3Fri<P3Fri<Fr, Blake2s>>;
