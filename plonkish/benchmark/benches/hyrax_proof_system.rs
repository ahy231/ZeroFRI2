...
use plonkish_backend::{
    ...
    halo2_curves::{bn256::{Bn256,G1Affine, Fr}, secp256k1::Fp},
    pcs::{
        // Possibly two different FRI implementations (multilinear vs. univariate).
        multilinear::MultilinearHyrax,
...
const OUTPUT_DIR: &str = "./bench_data/hyrax";
...
fn bench_hyperplonk<C: CircuitExt<Fr>>(k: usize) {
    ...
    type HyraxPcs = MultilinearHyrax<G1Affine>;
    // 2) Our HyperPlonk backend uses Hyrax as the polynomial commitment scheme.
    type HyperPlonk = backend::hyperplonk::HyperPlonk<HyraxPcs>;
